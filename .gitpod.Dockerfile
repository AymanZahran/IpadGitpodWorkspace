...
# Install Utils
RUN yes | unminimize && set -eux; apt install -y --no-install-recommends ca-certificates curl netbase wget tzdata gnupg dirmngr bzr git mercurial openssh-client subversion \
